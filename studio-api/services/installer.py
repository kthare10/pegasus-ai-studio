...
# Order here is the Workbench/Settings display order. `paid: True` flags tools
# that run on the user's own LLM API tokens (shown as a "Paid" badge).
# JupyterLab (Notebooks nav) and PegasusAI Chat (built-in slide-in + JupyterLab
# panel) are intentionally NOT marketplace tools — they have dedicated entry
# points and aren't installable AI CLIs.
