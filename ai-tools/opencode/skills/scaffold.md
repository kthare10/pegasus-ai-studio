...
- **ALWAYS create the workflow under `/home/jovyan/work/`** — the ONLY persistent, visible directory
...
```bash
mkdir -p /home/jovyan/work/{pipeline-name}-workflow/{bin,Docker}
```
...
```bash
ls -R /home/jovyan/work/{pipeline-name}-workflow/
```
